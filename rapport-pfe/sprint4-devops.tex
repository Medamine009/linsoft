%############################################################################
%  Demarche DevOps - contenu du Sprint 4
%  Inclus depuis chapitre-realisation-2.tex
%  Niveaux : subsection / subsubsection (le sprint est deja une section)
%############################################################################

\subsection{Stratégie de test}

\subsubsection{Pyramide de test retenue}
...
\subsubsection{Séparation des tests rapides et des tests d'infrastructure}
...
\subsubsection{Répartition obtenue}
...
\subsubsection{Exemples de règles protégées}
...
\subsubsection{Tests d'intégration avec Testcontainers}
...
%============================================================================
\subsection{Qualité du code et couverture}
...
\subsubsection{Couverture mesurée}
...
\subsubsection{Un défaut de conception corrigé}
...
%============================================================================
\subsection{Intégration et livraison continues}
...
\subsubsection{Choix : ne pas compiler dans les images}
...
\subsubsection{Garde-fou contre les faux positifs}
...
\subsubsection{Deux défauts révélés par les premières exécutions}
...
\subsubsection{Points de mesure}
...
\subsubsection{Collecte et visualisation}
...
%============================================================================
\subsection{Sécurité de la chaîne}
...
%============================================================================
\subsection{Illustrations du parcours fonctionnel}
...
%============================================================================
\subsection{Bilan de la démarche DevOps}
La démarche présentée dans ce sprint a fait passer le projet de dix-huit tests sans mesure
